...
const SPONSORS_DATA = {
  ...
  local: [
    ...
    { id: 11, name: "Junta de Freguesia de S. Romão", logo: "https://ik.imagekit.io/xqd9lrvbt/gemini-2.5-flash-image_melhora-me_este_logo_sem_mudar_nada_e_remove_o_fundo-2.jpg", url: "#" },
  ]
};
