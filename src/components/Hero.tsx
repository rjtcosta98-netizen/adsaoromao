  ...
  return (
    <div className="relative min-h-screen md:min-h-[100vh] md:h-[85vh] w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 h-full flex flex-col justify-center lg:flex-row lg:items-center lg:justify-between">
        ...
        {nextMatch.homeTeam && (
          <div className="w-full max-w-md lg:absolute lg:right-10 lg:top-1/2 lg:-translate-y-1/2 rounded-xl overflow-hidden backdrop-blur-xl border border-white/20 bg-navy-900/40 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)]">
            {/* Header */}
            ...
            <div className="p-4 sm:p-8 flex items-center justify-between relative">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full blur-2xl bg-blue-500/20" />
              ...
              <div className="flex flex-col items-center relative z-10 mx-2 sm:mx-4">
                <div className="rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center font-bold text-lg sm:text-xl shadow-lg border-2 sm:border-4 bg-yellow-400 text-navy-900 border-navy-900/50">
                  VS
                </div>
              </div>
            ...
            {/* Date / Location */}
            <div className="p-4 sm:p-5 text-center border-t border-white/10 bg-navy-900/60">
