...
export const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-navy-900 text-white p-4 md:p-6 border-t border-gold-400 shadow-2xl">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          
          {/* Content */}
          <div className="flex items-start gap-3 md:gap-4 flex-1">
            <Cookie size={20} className="text-gold-400 shrink-0 mt-0.5" />
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-300 leading-relaxed">
                ...
                <a href="#" className="text-gold-400 hover:underline ml-1">Saiba mais</a>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0 w-full md:w-auto">
            ...
            <button
              ...
              className="flex-1 md:flex-none px-4 py-2 rounded bg-gold-400 text-navy-900 hover:bg-gold-500 text-xs md:text-sm font-bold uppercase tracking-wider transition-colors"
            >
              Aceitar
            </button>
            <button
