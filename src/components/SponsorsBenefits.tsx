  ...
  return (
    ...
    <div className="relative py-24 bg-navy-900 border-t border-white/5 overflow-hidden">
          ...
          {benefits.map((item, index) => (
            <div 
              ...
              className={`
                ...
                ${item.isHighlight 
                  ? 'border border-gold-400/50 shadow-[0_0_40px_rgba(255,215,0,0.1)]' 
            ...
            >
               ...
               <div className="bg-navy-950/80 backdrop-blur-sm py-4 text-center border-b border-white/5">
                  <span className={`text-xs font-bold uppercase tracking-[0.2em] ${item.isHighlight ? 'text-gold-400' : 'text-gold-500'}`}>
                    {item.title}
                  </span>
               </div>
               ...
               <div className="bg-navy-900/80 backdrop-blur-sm p-8 flex-grow flex flex-col items-center text-center">
                  <div className="mb-6 transform hover:scale-110 transition-transform duration-300">
                     <item.icon size={48} className={item.isHighlight ? 'text-gold-400 drop-shadow-[0_0_15px_rgba(255,215,0,0.5)]' : 'text-blue-500'} strokeWidth={1.5} />
                  </div>
               ...
               <div className="bg-navy-950/90 backdrop-blur-sm py-4 text-center border-t border-white/5">
                  <span className={`text-[10px] font-bold uppercase tracking-wider ${item.isHighlight ? 'text-gold-400' : 'text-blue-400'}`}>
                    {item.footer}
                  </span>
               </div>
            </div>
      ...
      <div className="container mx-auto">
        <div className="border border-gold-400 rounded-2xl p-12 md:p-16 text-center relative overflow-hidden bg-navy-800/30">
          ...
          <div className="relative z-10">
            ...
            <button className="bg-gold-400 hover:bg-gold-500 text-navy-900 font-bold py-4 px-10 rounded shadow-lg uppercase text-sm tracking-widest transition-transform hover:scale-105">
              Enviar Proposta
            </button>
          </div>
